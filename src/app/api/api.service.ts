...
export class ApiService {
		...
		return new Promise((resolve, reject) => {
			this._http
				...
				.then((res: BlapiResponse) => {
					this.validateAndReturnResponse(res)
				...
				.catch((httpErrorResponse: HttpErrorResponse) => {
					...
					this.fetchTokensAndGet(url, httpErrorResponse, query)
						.then((apiRes: ApiResponse) => {
							resolve(apiRes);
						})
	...
	private fetchTokensAndGet(
		collection: string,
		httpError: HttpErrorResponse,
		query?: string
	): Promise<ApiResponse> {
		return new Promise((resolve, reject) => {
			if (this._apiErrorService.isAccessTokenInvalid(httpError)) {
				// accessToken invalid
				this._apiTokenService.fetchNewTokens().then(() => {
					this._http
						.get(
							this._apiRequestService.apiPath(collection, query),
							{ headers: this._apiRequestService.getHeaders() }
						)
						.toPromise()
						.then((res: BlapiResponse) => {
		...
		return new Promise((resolve, reject) => {
			this._http
				...
				.catch((httpError: HttpErrorResponse) => {
					this.fetchTokensAndGetById(collection, id, httpError)
						.then((res: BlapiResponse) => {
							resolve(this.validateAndReturnResponse(res));
						})
						.catch((blApiErr: BlApiError) => {
			...
			if (this._apiErrorService.isAccessTokenInvalid(httpError)) {
				...
				this._apiTokenService
					...
					.then(() => {
						...
						this._http
							.get(
								this._apiRequestService.apiPathWithId(
									collection,
									id
								),
								{
	...
	public add(collection: string, data: any): Promise<ApiResponse> {
		return new Promise((resolve, reject) => {
			this._http
				...
				.catch((httpError: HttpErrorResponse) => {
					this.fetchTokensAndAdd(collection, data, httpError)
						.then((res: BlapiResponse) => {
							resolve(this.validateAndReturnResponse(res));
						})
						.catch((blApiErr: BlApiError) => {
	...
	public update(
		...
		return new Promise((resolve, reject) => {
			this._http
				.patch(
					this._apiRequestService.apiPathWithId(collection, id),
					data,
					{ headers: this._apiRequestService.getHeaders() }
				)
				.toPromise()
				...
				.catch((httpError: HttpErrorResponse) => {
					this.fetchTokensAndUpdate(collection, id, data, httpError)
						.then((res: BlapiResponse) => {
							resolve(this.validateAndReturnResponse(res));
						})
						.catch((blApiErr: BlApiError) => {
	...
	public remove(collection: string, id: string): Promise<ApiResponse> {
		return new Promise((resolve, reject) => {
			this._http
				...
				.catch((httpError: HttpErrorResponse) => {
					this.fetchTokensAndRemove(collection, id, httpError)
						.then((res: BlapiResponse) => {
							resolve(this.validateAndReturnResponse(res));
						})
						.catch((blApiErr: BlApiError) => {
	...
	private handleResponse(res: BlapiResponse): ApiResponse {
		try {
			...
			throw new Error(
				"BlApiDocumentError: response document is not valid: " + err
			);
		}
